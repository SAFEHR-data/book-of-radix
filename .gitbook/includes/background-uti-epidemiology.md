---
title: Background - UTI epidemiology
---
...
This high rate of resistance in urinary pathogens means that empirical antibiotic prescribing can result in a bug-drug mismatch, where the prescribed antibiotic does not effectively treat the bacteria it is targeting. This may be due to resistance that has developed over time through an individual's exposure to antibiotics, or from acquisition of resistant bacteria from the environment.&#x20;

Whether a prescribed antibiotic is discordant with a patient's microbiology is determined by susceptibility testing, with clinical breakpoints set by The European Committee on Antimicrobial Susceptibility Testing (EUCAST), updated annually. Susceptibility categories are defined as: S (Susceptible), I (Susceptible at Increased Exposure), and R (Resistant). A bug-drug mismatch is when the bacteria isolated is found to be resistant to the antibiotic prescribed.
