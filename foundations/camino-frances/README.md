...
* **Passport**: Extracts data from Epic's [Clarity](https://datahandbook.epic.com/ClarityDictionary) data warehouse into Parquet staging files.
* **Pilgrimage**: Ingests data from Parquet staging files into a [DuckLake](https://ducklake.select/) data lake.
* **Planning**: Camino orchestration and scheduling with Prefect.
* **Portal**: For researchers: [marimo](https://marimo.io/), [RStudio](https://posit.co/products/open-source/rstudio-server/) and [SuperSet](https://superset.apache.org/) instances with access to the Camino data lake.
